    ...
    const promptMasterHtml = isInspiration ? '' : `
          <div class="rt-prompt-master-panel" id="rt-prompt-master-panel" hidden>
            ...
            <div class="rt-prompt-master-actions">
              <button type="button" class="btn-ghost rt-prompt-master-action" id="rt-prompt-master-optimize">optimize</button>
              <button type="button" class="btn-ghost rt-prompt-master-action" id="rt-prompt-master-send">send</button>
              <button type="button" class="btn-ghost rt-prompt-master-action" id="rt-prompt-master-cancel">cancel</button>
            </div>
